...
export const metadata: Metadata = {
  ...
  description:
    "Join Pawlo's affiliate program and earn recurring commissions promoting an app pet parents love. 25–30% commission, complimentary lifetime access, and real-time earnings dashboard.",
  alternates: {
