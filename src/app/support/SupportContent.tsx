    ...
    items: [
      {
        ...
        answer: "Make sure all devices are connected to the internet. Try pulling down on the task list to force a refresh. If the issue persists, try signing out and back in. If you're still having trouble, contact us at contact@getpawlo.app.",
      },
      {
  ...
  return (
    <div className={styles.categories}>
      ...
      <div className={styles.contact}>
        ...
        <a href="mailto:contact@getpawlo.app" className="btn btn--primary">
          Contact Support
        </a>
      </div>
    </div>
