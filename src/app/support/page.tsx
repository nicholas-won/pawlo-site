...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "What does Pawlo include?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "All Pawlo plans include full access to every feature: unlimited pet profiles, unlimited household members, daily task tracking, Conflict Detection, household streaks, home screen widgets, smart reminders, full care history, custom task types, and priority support. Start with a 7-day free trial.",
      },
    },
    {
      "@type": "Question",
      name: "How much does Pawlo cost?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pawlo offers three plans: Monthly ($3.99/month), Yearly ($24.99/year — save 48%), and Lifetime ($199.99 one-time — limited launch offer). All plans include full access to every feature. Every plan starts with a 7-day free trial.",
      },
    },
    {
      "@type": "Question",
